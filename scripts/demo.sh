...
# Pane 0: Crypto server / helper service (top-left)
...
# Split vertically: Pane 2 (bottom) — Client auto-pay demo
tmux split-window -v -t mpp-demo
tmux send-keys -t mpp-demo "sleep 4 && bash scripts/live-e2e.sh" Enter
